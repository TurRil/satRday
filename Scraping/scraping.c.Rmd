...
```{r}
url <- "http://www.tennis-data.co.uk/2017/usopen.csv"
...
Based on generated html - loaded from JSON
...
tennis.html <- read_html("http://tennisabstract.com/reports/atp_elo_ratings.html")

tennis.data <- tennis.html %>% 
